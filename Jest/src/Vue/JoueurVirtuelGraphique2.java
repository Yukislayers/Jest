...
public class JoueurVirtuelGraphique2 extends JPanel{
	...
	public JoueurVirtuelGraphique2() {
	...
	public void refresh() {
		...
		b1.setIcon(new ImageIcon("Images\\"+joueur.getOffre().get(0).getTypeCarte()+"_retourne2.png"));
		b2.setIcon(new ImageIcon("Images\\"+joueur.getOffre().get(1).getTypeCarte()+"_retourne2.png"));
	}
	/**
